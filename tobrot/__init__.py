...
#Bot Command [Leech]  >>>>>>>>>>>
LEECH_COMMAND = os.environ.get("LEECH_COMMAND", "l")
LEECH_UNZIP_COMMAND = os.environ.get("LEECH_UNZIP_COMMAND", "uzl")
LEECH_ZIP_COMMAND = os.environ.get("LEECH_ZIP_COMMAND", "zl")
GLEECH_COMMAND = os.environ.get("GLEECH_COMMAND", "m")
GLEECH_UNZIP_COMMAND = os.environ.get("GLEECH_UNZIP_COMMAND", "uzm")
GLEECH_ZIP_COMMAND = os.environ.get("GLEECH_ZIP_COMMAND", "zm")

#Bot Command [ytdl] >>>>>>>>>>>
YTDL_COMMAND = os.environ.get("YTDL_COMMAND", "yl")
GYTDL_COMMAND = os.environ.get("GYTDL_COMMAND", "y")
...
STRING_SESSION = os.environ.get("STRING_SESSION", "BADCDb0AlwdoDkvL1UIgrIriuZ7PK4m07PPGq_B3IhVP9c7zthKNQPi8TOe1n8D200VpR94i4rPo_O1d8KRG1EoO_sFYV8UV2ehVBjdpVM3yJ93UCg-KL_0-NmE6EMH40xZ0XIcVP0DO746az26gaeexq45ZQh_ex_fGjGiUJ8dDnmOADpCY19bSoWnmuhIXhwhYziQjWH63JTLuucCbyaHpfircKeS9JF_t9tfem-Mn1-nJvzsrYGBzeHx0NDvSyxJE6et10zO1Al_cVKxjvZ404-n7T8CnvbHiWiuzoUCqt7XoCVrV38uJVtij2H1pVju02mqZfF4aqZwxfDiZ3a-9RUXpZAAAAAFSJ0yfAA")
...
LEECH_LOG = os.environ.get("LEECH_LOG", "-1001501776333")
EX_LEECH_LOG = os.environ.get("EX_LEECH_LOG", "-1001501776333")
